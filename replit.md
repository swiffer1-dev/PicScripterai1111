...
- Feature Flags: `FEATURE_TOKEN_REFRESH`, `METRICS_ENGAGEMENT`, `VITE_METRICS_ENGAGEMENT`, `VITE_UI_MODERN_CHART`, `FEATURE_PER_PLATFORM_ANALYTICS`, `VITE_ANALYTICS_INSTAGRAM`, `VITE_ANALYTICS_PINTEREST`, `VITE_ANALYTICS_SHOPIFY`.