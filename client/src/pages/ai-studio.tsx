            ...
            <div className="space-y-6">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                <div className="space-y-6">
                  {/* Step 1: Category */}
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground mb-3">Step 1: Category</h3>
                    <CategorySelector
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground mb-3">Step 2: Language & Tone</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground mb-3">Step 3: Style Options</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground mb-3">Step 4: Custom Instructions (Optional)</h3>
                    <textarea
                      value={customPrompt}
