...
export function TopPostsCard({ posts }: TopPostsCardProps) {
  ...
  return (
    <div className="rounded-2xl bg-slate-900/80 border border-slate-800 shadow-lg p-6 hover:shadow-xl hover:border-purple-500/60 hover:-translate-y-[1px] transition-all duration-200">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-white">Top Posts (Last 30 Days)</h3>
            ...
            return (
              ...
              >
                ...
                {mediaUrl ? (
                  ...
                  <div className="w-16 h-16 rounded-lg bg-slate-700/50 flex items-center justify-center flex-shrink-0 border border-slate-700">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-xs text-slate-400">
                    {metrics ? (
                      ...
                      <span className="capitalize px-2 py-0.5 bg-purple-500/10 text-purple-400 rounded text-xs">
                        {post.platform}
                      </span>
                    )}
                  </div>
